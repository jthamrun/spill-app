...
import { User, signOut as signOutFirebase } from "firebase/auth";
import { auth } from "../../firebase.config";
import { useRouter } from "next/navigation";

type Props = {
    session: Awaited<ReturnType<typeof getServerSession>> | User;
};
...
function NavigationOptions({ session }: Props) {
    ...
    if (session)
        return (
            ...
            <h1 className="transition duration-150 hover:underline hover:underline-offset-4 cursor-pointer hidden">
              Friends
            </h1>
          </Link> */}
